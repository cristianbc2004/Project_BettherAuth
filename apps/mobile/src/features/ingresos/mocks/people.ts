import type { IncomePerson, IncomePersonSale, IncomeSaleLocation } from "@repo/types/ingresos";
...
export const incomePeople: IncomePerson[] = [
  {
    ...
    observacion: "Highest income generation in the period",
  ...
  },
  {
    ...
    observacion: "Strong performance in corporate sales",
    porcentajeDelTotal: 26.3,
    ventas: carlosSales,
    ventasRealizadas: carlosSales.length,
  },
  {
    cargo: "Account representative",
    comision: 645,
    id: 3,
    ingresos: 4300,
    location: {
    ...
    observacion: "Stable performance during the month",
  ...
  },
  {
    ...
    observacion: "Lower income, but with growth potential",
